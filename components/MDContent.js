    ...
    return (
        ...
        <div className="markdown-rendered">
            <Alert severity="info">
                ...
                🌱 <strong>Follow</strong> or <strong>DM</strong> me on Pinterest at <span><a
                href="https://www.pinterest.co.kr/lifesproutz/">@BrotherJOE</a></span>
            </Alert>
            ...
            <hr/>
            <footer>
                <p>Powered by  <a href="https://blog.lifesproutz.com">BrotherJOE</a>, © 2022</p>
            </footer>
        </div>
    );
}
